...
// Supriya Naidu
// Lecture 21: reading from a file using a loop
...
int main()
{
    ...
    while(file_in >> course_code[position])
    {
    ...
    // approach 2
    // eof() - end of file -> returns true if we have reached the end of the file and false otehrwise
    // int position = 0;
